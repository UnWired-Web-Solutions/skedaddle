...
- [ ] Diagnose and fix the production exact-draft PDF export failure: Puppeteer reports a detached `about:blank` execution context after the report preview succeeds
