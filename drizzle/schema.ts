...
export const salesforceWorkbookSources = mysqlTable("salesforce_workbook_sources", {
  ...
  lastDriveVersion: varchar("lastDriveVersion", { length: 32 }),
  lastDriveModifiedAt: varchar("lastDriveModifiedAt", { length: 40 }),
...
export const salesforceWorkbookImportRuns = mysqlTable("salesforce_workbook_import_runs", {
  ...
  driveVersion: varchar("driveVersion", { length: 32 }),
  driveModifiedAt: varchar("driveModifiedAt", { length: 40 }),
